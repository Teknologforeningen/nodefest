...
router.post('/submit/', function(req, res, next) {
  ...
  if (req.validationErrors()) {
    ...
    db.query("INSERT INTO Participants(first_name, last_name, organisation, greeting, email, diet, alcoholfree, sillis, solenn_akt, avec, misc, category) VALUES ('" + req.body.first_name + "', '"
              + req.body.last_name + "', '"
              + req.body.organisation + "', "
              + (req.body.greeting ? "TRUE" : "FALSE") + ", '" 
              + req.body.email + "', '" 
              + req.body.diet + "', " 
              + (req.body.alcoholfree ? "TRUE" : "FALSE") + ", " 
              + (req.body.sillis ? "TRUE" : "FALSE") + ", " 
              + (req.body.solenn_akt ? "TRUE" : "FALSE") + ", '" 
              + req.body.avec + "', '" 
              + req.body.misc + "', '" 
              + req.body.price + "');")
        .then(function() {
